...
namespace Mollie\Subscription\RecurringOrder\DataHandler;
...
use PrestaShop\PrestaShop\Core\Domain\Customer\ValueObject\RecurringOrderId;
use PrestaShop\PrestaShop\Core\Form\IdentifiableObject\DataHandler\FormDataHandlerInterface;

/**
 * Saves or updates customer data submitted in form
 */
class RecurringOrderFormDataHandler implements FormDataHandlerInterface
{
    /**
    ...
    public function create(array $data)
    {
        ...
        /** @var RecurringOrderId $recurringOrderId */
        $recurringOrderId = $this->bus->handle($command);

        return $recurringOrderId->getValue();
    }

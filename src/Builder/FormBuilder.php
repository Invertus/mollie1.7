...
class FormBuilder
{
	...
	private function getAdvancedSettingsSection()
	{
	...
	public function buildAdvancedSettingsForm()
	{
		...
		$helper->token = Tools::getAdminTokenLite(Mollie::ADMIN_MOLLIE_ADVANCED_SETTINGS_CONTROLLER);
		...
		return $helper->generateForm([$this->getAdvancedSettingsSection()]);
	}
}

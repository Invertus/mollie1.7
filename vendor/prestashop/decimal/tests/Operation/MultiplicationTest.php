...
use test\PrestaShop\Decimal\Operation\Multiplication;
class MultiplicationTest extends \test\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItMultipliesNumbers($number1, $number2, $expectedResult)
    {
        ...
        $operation = new \test\PrestaShop\Decimal\Operation\Multiplication();

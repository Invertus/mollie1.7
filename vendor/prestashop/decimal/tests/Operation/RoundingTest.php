...
class RoundingTest extends \test\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $decimalNumber = new \test\PrestaShop\Decimal\DecimalNumber('1.2345');
        $rounding = new \test\PrestaShop\Decimal\Operation\Rounding();
    ...
    public function testItThrowsExceptionIfPrecisionIsInvalid($precision)
    {
        $decimalNumber = new \test\PrestaShop\Decimal\DecimalNumber('1.2345');
        $rounding = new \test\PrestaShop\Decimal\Operation\Rounding();
        $rounding->compute($decimalNumber, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_FLOOR);
    }
    /**
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, $expected);
    }
    /**
     * Given a decimal number
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, $expected);
    }
    /**
     * Given a decimal number
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_FLOOR, $expected);
    }
    /**
     * Given a decimal number
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, $expected);
    }
    /**
     * Given a decimal number
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_DOWN, $expected);
    }
    /**
     * Given a decimal number
    ...
    {
        $this->roundNumber($number, $precision, \test\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_EVEN, $expected);
    }
    /**

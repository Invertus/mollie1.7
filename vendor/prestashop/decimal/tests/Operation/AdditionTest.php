...
use test\PrestaShop\Decimal\Operation\Addition;
class AdditionTest extends \test\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItAddsNumbers($number1, $number2, $expectedResult)
    {
        ...
        $operation = new \test\PrestaShop\Decimal\Operation\Addition();

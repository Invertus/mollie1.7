...
use MolliePrefix\Symfony\Component\Debug\FatalErrorHandler\ClassNotFoundFatalErrorHandler;
class ClassNotFoundFatalErrorHandlerTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testHandleClassNotFound($error, $translatedMessage, $autoloader = null)
    {
        ...
        $handler = new \MolliePrefix\Symfony\Component\Debug\FatalErrorHandler\ClassNotFoundFatalErrorHandler();
        ...
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Debug\\Exception\\ClassNotFoundException', $exception);
    ...
    public function testCannotRedeclareClass()
    {
        ...
        $error = ['type' => 1, 'line' => 12, 'file' => 'foo.php', 'message' => 'Class \'Foo\\Bar\\RequiredTwice\' not found'];
        $handler = new \MolliePrefix\Symfony\Component\Debug\FatalErrorHandler\ClassNotFoundFatalErrorHandler();
        $exception = $handler->handleError($error, new \MolliePrefix\Symfony\Component\Debug\Exception\FatalErrorException('', 0, $error['type'], $error['file'], $error['line']));
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Debug\\Exception\\ClassNotFoundException', $exception);
    }
